    ...
    return (<div className={cn("grid gap-2", className)}>
      <Popover>
        ...
        <PopoverContent className="w-auto p-0" align="start">
          <Calendar initialFocus mode="range" defaultMonth={value === null || value === void 0 ? void 0 : value.from} selected={value} onSelect={function (value) { return onChange(value); }} numberOfMonths={2}/>
        </PopoverContent>
      </Popover>
    </div>);
}
//# sourceMappingURL=date-range-picker.jsx.map