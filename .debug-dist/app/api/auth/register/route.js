...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var body, _a, name_1, email, password, existingUser, hashedPassword, user, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    body = _b.sent();
                    _a = registerSchema.parse(body), name_1 = _a.name, email = _a.email, password = _a.password;
                ...
                case 2:
                    ...
                    if (existingUser) {
                        return [2 /*return*/, NextResponse.json({ error: 'User with this email already exists' }, { status: 400 })];
                    }
