...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, session, subtitle, filename, error_1;
        var _c;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, prisma.subtitle.findFirst({
                            where: {
                                id: id,
                                job: {
                ...
                case 3:
                    subtitle = _d.sent();
                    if (!subtitle) {
                        return [2 /*return*/, NextResponse.json({ error: 'Subtitle not found' }, { status: 404 })];
                    }
                    // Update download count
                    return [4 /*yield*/, prisma.subtitle.update({
                            where: { id: id },
                ...
                case 4:
                    // Update download count
                    _d.sent();
                    filename = "".concat(subtitle.job.title, "_").concat(subtitle.language, ".").concat(subtitle.format.toLowerCase());
                    // Return file content
                    return [2 /*return*/, new NextResponse(subtitle.content, {
                            headers: {
                ...
                case 5:
                    error_1 = _d.sent();
                    console.error('Download subtitle error:', error_1);
