            ...
            switch (_d.label) {
                ...
                case 3:
                    ...
                    if (job.status !== "FAILED") {
                        return [2 /*return*/, NextResponse.json({ error: "Only failed jobs can be retried" }, { status: 400 })];
                    }
                    // Retry the job
                    return [4 /*yield*/, jobProcessor.retryJob(job.id)];
                case 4:
                    // Retry the job
                    _d.sent();
                ...
                case 5:
                    error_1 = _d.sent();
                    console.error("Retry job error:", error_1);
